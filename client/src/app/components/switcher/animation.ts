...
const center =      style({ transform: 'scale(1.0) translate(0,     0)',   'box-shadow': 'none', position: 'absolute', width: '100%' });

export const indexAnim = trigger('indexAnim', []);
export const activeAnim = trigger('activeAnim', []);
